...
summary: "let's see how to integrate Github and Google OAuth authentication using Auth.js (NextAuth) and Prisma with SvelteKit and protected routes and redirects"
date: '2023-09-28'
draft: false
tags: ['Svelte', 'TypeScript', 'Prisma']
authors: ['prabhu']
layout: PostSimple
---
...
I was working on a sveltekit project. basically it was an AI-SaaS application (https://dall-e-sveltekit.vercel.app) and i wanted to integreate Auth.js (Formerly known as NextAuth.js) and Prisma with SvelteKit. I was able to do it successfully. So i thought of sharing it with you guys.

You can check out the live demo here https://dall-e-sveltekit.vercel.app. It also includes stripe payments and webhooks implementation.
...
<CImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*P1bMQdFe6FAkjkGlAJLE3g.png" caption="Prisma Studio models" />
...
<CImage src="https://raw.githubusercontent.com/PrabhuKiran8790/sveltekit-authjs-prisma-template/main/static/login_page.png" caption="Login Page" />

<CImage src="https://raw.githubusercontent.com/PrabhuKiran8790/sveltekit-authjs-prisma-template/main/static/dashboard_page.png" caption="Dashboard Page" />

<CImage src="https://raw.githubusercontent.com/PrabhuKiran8790/sveltekit-authjs-prisma-template/main/static/prisma_studio.png" caption="Prisma Studio" />
